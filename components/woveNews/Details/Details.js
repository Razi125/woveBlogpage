...
const Details = () => {
    ...
    const Artical = 
        ...
        {/** Full Containt */}
         ...
         <div class='content'>
         <div>
            <h1>Expand your social media following effectively</h1>
        </div>
        </div>
        <div class='content'>
        <div>
            <p>Expanding social media is just a requirement for everything in this day and age. It is because Social media is slowly becoming the new go-to for marketing. However, building a good social media following can be tricky but can serve you with extraordinary outcomes for your business. At this point, approximately 10-20% of a website’s traffic comes from the social media networks alone, translating it to around 300 to 500k page views per month.</p>
        </div>
        </div>
        {/** Addtional Reading */}
        <div class='addRead'>
