            ...
            <div className='mx-auto md:px-6 container'>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center mt-6 mb-6 xl:mt-8 xl:mb-8 '>
                    ...
                    <div className='flex gap-4 justify-center items-center '>
                        <img className='md:w-[20px] xl:w-[32px] cursor-pointer' src='./images/twitter.svg' alt='' />
                        <img className='md:w-[20px] xl:w-[32px] cursor-pointer' src='./images/linked_in.svg' alt='' />
                        <img className='md:w-[20px] xl:w-[32px] cursor-pointer' src='./images/spotify.svg' alt='' />
                        <img className='md:w-[20px] xl:w-[32px] cursor-pointer' src='./images/gmail.svg' alt='' />
                    </div>
                </div>
                <div style={{ border: '1px solid #262626' }}></div>
